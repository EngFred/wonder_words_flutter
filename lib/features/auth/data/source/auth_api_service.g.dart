...
class _AuthApiService implements AuthApiService {
  ...
  @override
  Future<CreateUserResponse> createUser(NewUserRequest userRequest) async {
  ...
  Future<UserSessionResponse> loginUser(
    ...
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
    _data.addAll(userSessionRequest.toJson());
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<UserSessionResponse>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
    ...
    final value = UserSessionResponse.fromJson(_result.data!);
    return value;
  }
